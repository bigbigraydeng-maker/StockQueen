...
class RotationConfig:
    ...
    MIN_SCORE_BY_REGIME: dict = {
        "strong_bull":  0.0,  # 强牛：放宽，但不接受负分票
        "bull":         0.1,  # 牛市：排除贴底分数（AXTI 事件修复）
...
MIDCAP_STOCKS = [
    ...
    {"ticker": "CRWD", "name": "CrowdStrike",       "sector": "tech", "listed_since": "2019-06"},
    {"ticker": "NET",  "name": "Cloudflare",        "sector": "tech", "listed_since": "2019-09"},
    {"ticker": "DDOG", "name": "Datadog",            "sector": "tech", "listed_since": "2019-09"},
    {"ticker": "MDB",  "name": "MongoDB",            "sector": "tech", "listed_since": "2017-10"},
    {"ticker": "BILL", "name": "Bill.com",           "sector": "tech", "listed_since": "2019-12"},
    {"ticker": "ZS",   "name": "Zscaler",            "sector": "tech", "listed_since": "2018-03"},
    {"ticker": "CFLT", "name": "Confluent",          "sector": "tech", "listed_since": "2021-06"},
    ...
    {"ticker": "OKTA", "name": "Okta",               "sector": "tech", "listed_since": "2017-04"},
    {"ticker": "VRNS", "name": "Varonis Systems",    "sector": "tech"},
    {"ticker": "RPD",  "name": "Rapid7",             "sector": "tech"},
    {"ticker": "TENB", "name": "Tenable",            "sector": "tech", "listed_since": "2018-07"},
    ...
    {"ticker": "CRNX", "name": "Crinetics",         "sector": "bio", "listed_since": "2019-06"},
    {"ticker": "NUVB", "name": "Nuvation Bio",      "sector": "bio", "listed_since": "2021-01"},
    {"ticker": "MRNA", "name": "Moderna",           "sector": "bio", "listed_since": "2018-12"},
    ...
    {"ticker": "ESTC", "name": "Elastic",           "sector": "saas", "listed_since": "2018-10"},
    ...
    {"ticker": "DOMO", "name": "Domo Inc",          "sector": "saas", "listed_since": "2018-06"},
    ...
    # ── China ADR (15) ──
    {"ticker": "PDD",  "name": "PDD Holdings",      "sector": "china", "listed_since": "2018-07"},
    {"ticker": "BABA", "name": "Alibaba",           "sector": "china"},
    {"ticker": "JD",   "name": "JD.com",            "sector": "china"},
    {"ticker": "BIDU", "name": "Baidu",             "sector": "china"},
    {"ticker": "NIO",  "name": "NIO",               "sector": "china", "listed_since": "2018-09"},
    {"ticker": "XPEV", "name": "XPeng",             "sector": "china", "listed_since": "2020-08"},
    {"ticker": "LI",   "name": "Li Auto",           "sector": "china", "listed_since": "2020-07"},
    {"ticker": "BILI", "name": "Bilibili",          "sector": "china"},
    {"ticker": "TME",  "name": "Tencent Music",     "sector": "china", "listed_since": "2018-12"},
    ...
    {"ticker": "BE",   "name": "Bloom Energy",      "sector": "clean_energy", "listed_since": "2018-07"},
    ...
    {"ticker": "ROKU", "name": "Roku",              "sector": "media", "listed_since": "2017-09"},
    ...
    {"ticker": "WBD",  "name": "Warner Bros Disc",  "sector": "media", "listed_since": "2022-04"},
    {"ticker": "PARA", "name": "Paramount Global",  "sector": "media"},
    {"ticker": "LYV",  "name": "Live Nation",       "sector": "media"},
    {"ticker": "SPOT", "name": "Spotify",           "sector": "media", "listed_since": "2018-04"},
    ...
    {"ticker": "SILK", "name": "Silk Road Medical", "sector": "med_device", "listed_since": "2019-05"},
    ...
    {"ticker": "AXNX", "name": "Axonics",           "sector": "med_device", "listed_since": "2018-10"},
    ...
    {"ticker": "SNDR", "name": "Schneider National","sector": "transport", "listed_since": "2017-04"},
    ...
    {"ticker": "LBRT", "name": "Liberty Energy",    "sector": "energy", "listed_since": "2018-01"},
    ...
    # ── Crypto / Blockchain (5) ──
    {"ticker": "MARA", "name": "Marathon Digital",  "sector": "fintech", "listed_since": "2021-02"},
    {"ticker": "RIOT", "name": "Riot Platforms",    "sector": "fintech", "listed_since": "2021-03"},
    {"ticker": "CLSK", "name": "CleanSpark",        "sector": "fintech", "listed_since": "2020-08"},
    ...
    {"ticker": "CTVA", "name": "Corteva",           "sector": "materials", "listed_since": "2019-06"},
    {"ticker": "AVTR", "name": "Avantor",           "sector": "materials", "listed_since": "2019-05"},
    ...
    {"ticker": "RDFN", "name": "Redfin",            "sector": "reit", "listed_since": "2017-07"},
    ...
    {"ticker": "VICI", "name": "VICI Properties",   "sector": "reit", "listed_since": "2018-02"},
