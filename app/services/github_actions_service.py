...
COMPUTE_JOBS = [
    ...
    {
        "id": "wf_strategy_matrix",
        "priority": "🔴",
        "name": "Strategy Matrix 502股完整回测（V5.1分配矩阵）",
        "est": "~1小时",
        "workflow": "walk-forward.yml",
        "inputs": {"strategy": "v4"},
        "prereq": None,
    ...
    },
    {
        "id": "wf_ed_wf",
        "priority": "🟡",
        "name": "ED Walk-Forward + regime_series 修复重跑",
        "est": "~2小时",
        "workflow": "walk-forward.yml",
        "inputs": {"strategy": "ed"},
        "prereq": "需先修复 event_driven_service.py regime_series 传参",
        "ready": False,
    },
    {
    ...
    },
    {
        "id": "wf_monte_carlo",
        "priority": "🟢",
        "name": "Monte Carlo 修复重跑（MR + ED）",
        "est": "~1小时",
        "workflow": "walk-forward.yml",
        "inputs": {"strategy": "all"},
        "prereq": "需先修复 monte_carlo_test.py 方法论（随机入场日期 vs PnL顺序）",
        "ready": False,
    },
    {
        "id": "wf_dynamic_universe",
        "priority": "🔵",
        "name": "动态选股池 Walk-Forward（1578只，超6小时需 Modal）",
        "est": "~10小时",
        "workflow": "walk-forward.yml",
        "inputs": {"strategy": "v4"},
        "prereq": "需 Universe Scheduler 上线 + 迁移至 Modal.com（超 GitHub 6小时上限）",
        "ready": False,
    },
    {
        "id": "wf_survivor_bias",
        "priority": "🔵",
        "name": "幸存者偏差彻底修复 WF（含退市股，超6小时需 Modal）",
        "est": "~12小时",
        "workflow": "walk-forward.yml",
        "inputs": {"strategy": "v4"},
        "prereq": "需 FMP 迁移完成 + 迁移至 Modal.com",
        "ready": False,
    },
]
